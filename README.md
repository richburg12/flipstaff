...
- **Right thumb** — three buttons: **QUICK** (wrist-snap slash, 7 dmg, short
  ...
  pose held ~350 ms = punishable), **FLIP** (gravity — no cooldown; chained
  flips hover)
- Block stops frontal hits only; every block slides you back and a blocked
  heavy shoves you far. Backs are open. Airborne fighters take ~1.65x
  knockback — juggling someone toward the fire is the dream. KO or the pit
  wins the round, first to 3 wins.
